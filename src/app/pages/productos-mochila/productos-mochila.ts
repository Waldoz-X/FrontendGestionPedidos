...
@Component({
    ...
    template: `
        ...
        <p-dialog 
            ...
            [style]="{ width: '500px' }" 
            header="Carga Masiva de Mochilas" 
            [modal]="true"
        >
            <ng-template #content>
        ...
        <div class="card">
            <p-toolbar styleClass="mb-6">
                <ng-template #start>
                    <div>
                        <div class="font-semibold text-xl">Productos Mochila</div>
                        <p class="m-0 text-surface-500 dark:text-surface-400">Gestión de productos mochila en el sistema.</p>
                    </div>
                </ng-template>
                <ng-template #end>
            ...
            <p-table
                ...
                currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} mochilas"
            ...
            >
                ...
                <ng-template #emptymessage>
                    <tr>
                        <td colspan="6">No hay mochilas para mostrar.</td>
                    </tr>
                </ng-template>
            </p-table>
        </div>
        ...
        <p-dialog
            ...
            [style]="{ width: '900px' }"
            [header]="editando() ? 'Editar Mochila' : 'Nuevo Mochila'"
            [modal]="true"
        >
            <ng-template #content>
                <p-tabs value="0">
                            ...
                            <div class="flex flex-col gap-6 pt-4">
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="col-span-6 md:col-span-4">
                                        ...
                                        <input type="text" pInputText [(ngModel)]="datosFormulario.dsMaterialPrincipal" fluid />
                                    </div>
                                    <div class="col-span-6 md:col-span-4">
                                        <label class="block font-bold mb-3">Dimensiones</label>
                                        <input type="text" pInputText [(ngModel)]="datosFormulario.dsDimensiones" fluid />
                                    </div>
                                </div>

                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-6">
                                        <label class="block font-bold mb-3">Capacidad Litros</label>
                                        <input type="number" pInputText [(ngModel)]="datosFormulario.noCapacidadLitros" fluid />
                                    </div>
                                </div>

                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-6">
                                        <label class="block font-bold mb-3">Compartimentos</label>
                                        <p-select appendTo="body" [(ngModel)]="datosFormulario.clSubcategoria" [options]="subcategorias()" optionLabel="label" optionValue="cl" placeholder="Seleccionar" fluid />
                                    </div>
                                </div>
                            </div>
                        </p-tabpanel>
...
export class ProductosMochila implements OnInit {
    ...
    // ─── State ───
    productos = signal<ProductoMochila[]>([]);
    ...
    datosFormulario: CrearProductoMochilaRequest = {
        clProducto: '',
        nbProducto: '',
        idElemCategoria: 0,
...
noCompartimentos: 0,
    ...
    editarProducto(prod: ProductoMochila): void {
        ...
        this.loading.set(true);
        this.apiService.getProductoMochila(id).pipe(
            takeUntilDestroyed(this.destroyRef)
        ).subscribe({
            next: (fullProd: any) => {
                this.loading.set(false);
                ...
                this.datosFormulario = {
                    ...
                    clSubcategoria: fullProd.clSubcategoria || fullProd.ClSubcategoria || '',
dsMaterialPrincipal: fullProd.dsMaterialPrincipal || fullProd.DsMaterialPrincipal || '',
                    
                    
                    dsDimensiones: fullProd.dsDimensiones || fullProd.DsDimensiones || '',
                    noCapacidadLitros: fullProd.noCapacidadLitros || fullProd.NoCapacidadLitros || 0,
noCompartimentos: fullProd.noCompartimentos || fullProd.NoCompartimentos || 0,
            ...
            error: (err) => {
                ...
                this.messageService.add({ severity: 'error', summary: 'Error', detail: 'No se pudo cargar la información detallada del mochila.', life: 5000 });
            }
        });
    }
    ...
    guardar(): void {
        ...
        const request$ = this.editando() 
            ? this.apiService.actualizarProductoMochila(this.idEditando, this.datosFormulario)
            : this.apiService.crearProductoMochila(this.datosFormulario);
    ...
    confirmarEliminar(prod: ProductoMochila): void {
        this.confirmationService.confirm({
            message: '¿Eliminar el mochila ' + prod.nbProducto + '?',
            ...
            accept: () => {
                ...
                this.apiService.eliminarProductoMochila(id).pipe(
                    ...
                    next: () => {
                        this.cargarProductos();
                        this.messageService.add({ severity: 'success', summary: 'Eliminado', detail: 'Mochila eliminado correctamente.' });
                    },
