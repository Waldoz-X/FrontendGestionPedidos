...
import { 
    ProductoCono, 
    CrearProductoConoRequest, 
    ActualizarProductoConoRequest,
    VarianteNestedDtoCono,
    SkuNestedDtoCono
} from '../service/productos-cono/productos-cono-api.types';
    ...
    template: `
        ...
        <div class="card">
            <p-toolbar styleClass="mb-6">
                <ng-template #start>
                    <div>
                        <div class="font-semibold text-xl">Productos Cono</div>
                        <p class="m-0 text-surface-500 dark:text-surface-400">Gestión de productos cono en el sistema.</p>
                    </div>
                </ng-template>
                <ng-template #end>
            ...
            <p-table
                ...
                currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} conos"
            ...
            >
                <ng-template #caption>
                    <div class="flex items-center justify-between">
                        ...
                        <p-iconfield>
                            ...
                            <input pInputText type="number" (input)="onGlobalFilter(dt, $event)" placeholder="Buscar..." />
                        </p-iconfield>
                    </div>
                </ng-template>
                <ng-template #header>
                    <tr>
                        ...
                        <th pSortableColumn="dsMaterialPrincipal" style="min-width: 12rem">Material <p-sortIcon field="dsMaterialPrincipal" /></th>
                ...
                <ng-template #body let-prod>
                    <tr>
                        ...
                        <td>{{ prod.dsMaterialPrincipal || 'N/A' }}</td>
                        <td>
                ...
                <ng-template #emptymessage>
                    <tr>
                        <td colspan="6">No hay conos para mostrar.</td>
                    </tr>
                </ng-template>
            </p-table>
        </div>
        ...
        <p-dialog
            ...
            [style]="{ width: '900px' }"
            [header]="editando() ? 'Editar Cono' : 'Nuevo Cono'"
            [modal]="true"
        >
            <ng-template #content>
                <p-tabs value="0">
                    <p-tablist>
                        ...
                        <p-tab value="2"><i class="pi pi-tags mr-2"></i>Variantes y Subcategoría</p-tab>
                    </p-tablist>
                            ...
                            <div class="flex flex-col gap-6 pt-4">
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-6">
                                        ...
                                        <input type="number" pInputText [(ngModel)]="datosFormulario.clProducto" required fluid />
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <input type="number" pInputText [(ngModel)]="datosFormulario.nbProducto" required fluid />
                            ...
                            <div class="flex flex-col gap-6 pt-4">
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-6 md:col-span-4">
                                        ...
                                        <input type="number" pInputText [(ngModel)]="datosFormulario.clHsCode" fluid />
                                    </div>
                                    <div class="col-span-6 md:col-span-4">
                                        <label class="block font-bold mb-3">Material</label>
                                        <input type="text" pInputText [(ngModel)]="datosFormulario.dsMaterial" fluid />
                                    </div>
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-6">
                                        <label class="block font-bold mb-3">Altura (cm)</label>
                                        <input type="number" pInputText [(ngModel)]="datosFormulario.noAlturaCm" fluid />
                                    </div>
                                </div>
                            </div>
                        </p-tabpanel>
                                            ...
                                            <p-accordion-content>
                                                ...
                                                <div class="grid grid-cols-12 gap-4 mb-4">
                                                    ...
                                                    <div class="col-span-12 md:col-span-4">
                                                        ...
                                                        <input type="number" pInputText [(ngModel)]="variante.urlImagen" fluid />
                                                    </div>
                                                    <div class="col-span-12 md:col-span-4">
                                                ...
                                                <div class="bg-surface-50 dark:bg-surface-900 p-4 rounded-lg mt-4">
                                                    <div class="flex justify-between items-center mb-4">
                                                        <h4 class="font-bold m-0">Subcategoría (SKUs)</h4>
...
export class ProductosCono implements OnInit {
    ...
    datosFormulario: CrearProductoConoRequest = {
        clProducto: '',
        nbProducto: '',
        idElemCategoria: 0,
    ...
    cargarCatalogos(): void {
        ...
        fetchCatalogo('DIVISIONES', this.subcategorias, 'MOCHILA');
    }
    ...
    editarProducto(prod: ProductoCono): void {
        ...
        this.loading.set(true);
        this.apiService.getProductoCono(id).pipe(
            takeUntilDestroyed(this.destroyRef)
        ).subscribe({
            next: (fullProd: any) => {
                this.loading.set(false);
                ...
                this.datosFormulario = {
                    ...
                    noAlturaCm: Number(fullProd.noAlturaCm || fullProd.NoAlturaCm || 0),
dsMaterial: fullProd.dsMaterial || fullProd.DsMaterial || '',
                    
                    
                                                            fgEsUnitalla: fullProd.fgEsUnitalla || fullProd.FgEsUnitalla || false,
            ...
            error: (err) => {
                ...
                this.messageService.add({ severity: 'error', summary: 'Error', detail: 'No se pudo cargar la información detallada del cono.', life: 5000 });
            }
        });
    }
    ...
    guardar(): void {
        ...
        const request$ = this.editando() 
            ? this.apiService.actualizarProductoCono(this.idEditando, this.datosFormulario)
            : this.apiService.crearProductoCono(this.datosFormulario);
        ...
        request$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
            ...
            error: (err: HttpErrorResponse) => {
                this.saving.set(false);
                this.messageService.add({ severity: 'error', summary: 'Error al guardar', detail: 'Ocurrió un error al intentar guardar el cono.' });
            }
        });
    }

    confirmarEliminar(prod: ProductoCono): void {
        this.confirmationService.confirm({
            message: '¿Eliminar el cono ' + prod.nbProducto + '?',
            ...
            accept: () => {
                ...
                this.apiService.eliminarProductoCono(id).pipe(
                    ...
                    next: () => {
                        this.cargarProductos();
                        this.messageService.add({ severity: 'success', summary: 'Eliminado', detail: 'Cono eliminado correctamente.' });
                    },
