...
@Component({
    ...
    template: `
        ...
        <p-dialog 
            ...
            [style]="{ width: '500px' }" 
            header="Carga Masiva de Accesorios" 
            [modal]="true"
        >
            <ng-template #content>
        ...
        <div class="card">
            <p-toolbar styleClass="mb-6">
                <ng-template #start>
                    <div>
                        <div class="font-semibold text-xl">Productos Accesorio</div>
                        <p class="m-0 text-surface-500 dark:text-surface-400">Gestión de productos accesorio en el sistema.</p>
                    </div>
                </ng-template>
                <ng-template #end>
            ...
            >
                ...
                <ng-template #emptymessage>
                    <tr>
                        <td colspan="6">No hay accesorios para mostrar.</td>
                    </tr>
                </ng-template>
            </p-table>
        </div>
        ...
        <p-dialog
            ...
            [style]="{ width: '900px' }"
            [header]="editando() ? 'Editar Accesorio' : 'Nuevo Accesorio'"
            [modal]="true"
        >
            <ng-template #content>
                <p-tabs value="0">
                    ...
                    <p-tabpanels>
                        ...
                        <p-tabpanel value="1">
                            <div class="flex flex-col gap-6 pt-4">
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    <div class="col-span-6">
                                        <label class="block font-bold mb-3">Subcategoría</label>
...
export class ProductosAccesorio implements OnInit {
    ...
    // ─── State ───
    productos = signal<ProductoAccesorio[]>([]);
    ...
    datosFormulario: CrearProductoAccesorioRequest = {
        clProducto: '',
        nbProducto: '',
        idElemCategoria: 0,
    ...
    editarProducto(prod: ProductoAccesorio): void {
        ...
        this.loading.set(true);
        this.apiService.getProductoAccesorio(id).pipe(
            takeUntilDestroyed(this.destroyRef)
        ).subscribe({
            next: (fullProd: any) => {
                this.loading.set(false);
...
dsMaterialPrincipal: fullProd.dsMaterialPrincipal || fullProd.DsMaterialPrincipal || '',
            ...
            error: (err) => {
                ...
                this.messageService.add({ severity: 'error', summary: 'Error', detail: 'No se pudo cargar la información detallada del accesorio.', life: 5000 });
            }
        });
    }
    ...
    guardar(): void {
        ...
        const request$ = this.editando() 
            ? this.apiService.actualizarProductoAccesorio(this.idEditando, this.datosFormulario)
            : this.apiService.crearProductoAccesorio(this.datosFormulario);
    ...
    confirmarEliminar(prod: ProductoAccesorio): void {
        this.confirmationService.confirm({
            message: '¿Eliminar el accesorio ' + prod.nbProducto + '?',
